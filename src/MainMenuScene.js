...
MainMenuScene.prototype.draw = function (ctx) {
  ...
  ctx.drawImage(ImageManager.getImage('battle_city'), 75, this._y + 80);
  ...
  ctx.drawImage(ImageManager.getImage('copyright'), 98, this._y + 384);
  ctx.fillText("2025 Spinning Cat", 123, this._y + 398);
